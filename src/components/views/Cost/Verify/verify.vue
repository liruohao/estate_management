    ...
    <div class="operation">
      <div>
        <table width="100%">
          <tr>
            <td>
              <span class="fontFloat">编码:</span>
              <Input v-model="select.code" style="width: 80%" />
            </td>
            <td class="tabfloat">
              <span class="fontFloat">类别:</span>
              <Input v-model="select.category" style="width: 80%" />
              <!--<Select v-model="select.category" style="width:75%;float: left">-->
                <!--<Option v-for="item in cityList" :value="item.value" :key="item.value">{{ item.label }}</Option>-->
              <!--</Select>-->
            </td>
            <td  class="tabfloat">
              <span class="fontFloat">分类:</span>
              <Input v-model="select.classification" style="width: 80%" />
            </td>
          </tr>
          <tr>
            <td>
              <span class="fontFloat">名称:</span>
              <Input v-model="select.name"  style="width: 83%"></Input>
            </td>
            <td class="tabfloat" style="padding-left: 4%">
              <span class="fontspecifications">规格:</span>
              <Input v-model="select.specifications  " style="width: 84%" />
            </td>
            <td class="tabbut">
...
<script>
  ...
  export default {
    ...
    methods:{
      ...
      handleSave (index) {
        this.historyData[index].code = this.editcode;
        this.historyData[index].category = this.editcategory;
        this.historyData[index].classification = this.editclassification;
        this.historyData[index].name = this.editname;
        this.historyData[index].specifications = this.editspecifications;
        this.historyData[index].materialScience = this.editmaterialScience;
        this.historyData[index].surface = this.editsurface;
        this.historyData[index].logo = this.editlogo;
        this.historyData[index].business = this.editbusiness;
      ...
      handleListApproveHistory(){
        //通过JSON引入数据
        this.$http.get('/api/something').then((response)=>{
