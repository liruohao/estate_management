  ...
  <div class="bgcolor">
        ...
        <table width="100%">
          ...
          <tr>
            ...
            <!--<td class="tabfloat" style="padding-left: 3.2%">-->
              ...
              <!--<Input v-model="select.power  " style="width: 72%" />-->
            <!--</td>-->
            <td class="tabbut">
    ...
    <Modal v-model="editorshow"  width="60%"
      ...
      <Form ref="formInline"  :model="formItem" :label-width="80" inline>
        ...
        <FormItem label="水费（¥）" class="titfloat">
          <Input id="rubric" value="${this.formItem.property}"  v-model="formItem.property" placeholder="请输入物业费（¥）" :disabled="this.falg ===3"></Input>
        </FormItem>
  ...
  export default {
    ...
    methods:{
      ...
      handleSave (index) {
        ...
        this.historyData[index].property = this.property;
      ...
      handleListApproveHistory(){
        //通过JSON引入数据
        this.$http.get('/api/payform').then((response)=>{
